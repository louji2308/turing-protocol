...
async function main() {
  ...
  console.log(`Verifying contracts on Mantle Testnet...`);
  ...
  console.log(`1. Go to https://explorer.testnet.mantle.xyz/`);
  ...
  console.log(`npx hardhat verify --network mantle_testnet ${oracleAddress} ${deployer.address} 100`);
  console.log(`npx hardhat verify --network mantle_testnet ${pobAddress} ${deployer.address} 7000`);
}
